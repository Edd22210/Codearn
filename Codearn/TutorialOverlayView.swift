...
struct TutorialOverlayView: View {
    ...
    let anchorPoints: [String: CGPoint]
    ...
    // MenuView layout (iPhone ~844pt screen):
    //   "Codearn" title + padding      ≈ 210pt of content
    //   Default VStack spacing ≈ 8pt between items
    //   Button height = 50pt
    //   Button 1 centre (Coding Languages): ≈ 330pt
    //   Button 2 centre (Certificates):     ≈ 388pt
    ...
    private let steps: [TutorialStep] = [
        ...
        TutorialStep(
            ...
            arrowDirection: .up,
            anchorAbsoluteY: 330,
            anchorTarget: "Coding Languages",
            anchorX: 0.5
        ),
        TutorialStep(
            title: "Certificates",
            body: "Open achievements and progress certificates for every language you practice.",
            arrowDirection: .up,
            anchorAbsoluteY: 388,
            anchorTarget: "Certificates",
            anchorX: 0.5
        ),
        TutorialStep(
            title: "Settings",
            ...
            arrowDirection: .up,
            anchorAbsoluteY: 446,
            anchorTarget: "Settings",
            anchorX: 0.5
        ),
    ]
    
    private func anchorY(for step: TutorialStep, in anchors: [String: CGPoint]) -> CGFloat? {
        if let target = step.anchorTarget, let point = anchors[target] {
            return point.y
        }
        return step.anchorAbsoluteY
    }
    ...
    var body: some View {
        GeometryReader { geo in
            ZStack {
                ...
                if let anchorY = anchorY(for: step, in: anchorPoints) {
                    Circle()
                    ...
                    Circle()
                        ...
                        .frame(
                            width:  glowPulse ? 128 : 90,
                            height: glowPulse ? 128 : 90
                        )
                        .position(x: geo.size.width * step.anchorX, y: anchorY)
                        .animation(
